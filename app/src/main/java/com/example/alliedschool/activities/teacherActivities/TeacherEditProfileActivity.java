...
public class TeacherEditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivChangeImage = findViewById(R.id.iv_teacher_change_profile_image);
        ivUserProfile = findViewById(R.id.iv_teacher_selected_image_e_p);

        findViewById(R.id.iv_teacher_edit_profile_back).setOnClickListener(new View.OnClickListener() {
            @Override
